...
import com.lzbruby.autocode.mybatis.generat.generator.Generator;
...
import com.lzbruby.autocode.mybatis.generat.utils.GeneratorFileUtils;
...
public abstract class BaseGenerator implements Generator {
    ...
    public void initVelocityContext(VelocityContext velocityContext, GeneratorContext generatorContext) {
        ...
        velocityContext.put("classTitle", assemblyAutoCreateClassTitle(generatorContext, generatorContext.getUpClassName()));
     ...
     * @return
     */
    protected String assemblyAutoCreateClassTitle(GeneratorContext generatorContext, String upClassName) {
        Properties properties = (Properties) generatorContext.getAttribute("properties");
        ...
        builder.append("/** ").append("\n")
                ...
                .append(" * email: ").append(System.getProperty("user.name")).append(properties.getProperty("class.email.suffix")).append("\n")
                .append(" * company: ").append(properties.getProperty("class.org")).append("\n")
